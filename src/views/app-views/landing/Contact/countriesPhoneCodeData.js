const CountriesPhoneCode = {
    ...
    'CC': { primary: 'Cocos Islands', secondary: '(+61)' },
    ...
    'DO': { primary: 'Dominican Republic', secondary: '(+1-809) (+1-829) (+1-849)' },
    'TL': { primary: 'East Timor', secondary: '(+670)' },
    ...
    'XK': { primary: 'Kosovo', secondary: '(+383)' },
    ...
    'PR': { primary: 'Puerto Rico', secondary: '(+1-787) (+1-939)' },
    'QA': { primary: 'Qatar', secondary: '(+974)' },
    'CG': { primary: 'Republic of the Congo', secondary: '(+242)' },
    ...
    'VI': { primary: 'U.S. Virgin Islands', secondary: '(+1-340)' },
    ...
    'VA': { primary: 'Vatican', secondary: '(+379)' },
...
export default CountriesPhoneCode